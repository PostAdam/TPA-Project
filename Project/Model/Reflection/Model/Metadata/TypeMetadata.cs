...
namespace Project.Model.Reflection.Model
{
    ...
    internal class TypeMetadata
    {
        ...
        private static IEnumerable<AttributeMetadata> EmitAttributes( IEnumerable<Attribute> attributes )
        {
            ...
            return from attribute in attributes
                select new AttributeMetadata( attribute.GetType().Name,
                    TypeMetadata.EmitReference( attribute.GetType() ) );
        }
        ...
        private static IEnumerable<FieldMetadata> EmitFields( IEnumerable<FieldInfo> fields )
        {
            ...
            return from field in fields
                select new FieldMetadata( field.Name, TypeMetadata.EmitReference( field.FieldType ) );
        }
